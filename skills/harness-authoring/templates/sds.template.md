...
#### {{MODULE_NAME}}
- Implemented requirements: [FR-001](../srs/README.md#fr-001) <!-- The SRS FRs this module
  satisfies (link via each FR anchor, serving as the standard Requirements Matrix). **For
  brownfield (no SRS generated), omit this field. Infrastructure/cross-cutting modules (logging,
  config, DB adapters) get "no FR mapping"** — no forced mappings or dead links. -->
