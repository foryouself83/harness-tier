...
- **Prerequisite**: repository Settings → Actions → Workflow permissions = **Read and write** (see [Promotion and release → Release token write permission](../usage/promotion-and-release.md#release-token-write-permission)).
