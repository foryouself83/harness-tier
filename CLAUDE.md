...
tests/           pytest over scripts/ · test_skills.py (skill FILES: frontmatter/links/refs + the git
                 commands they issue vs the gate's self-filter) · test_evals.py (model-free half of evals/)
