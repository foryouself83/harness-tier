...
# _HEADING_RE·_SETEXT_RE·_slugify are unused in this module's own body — re-exported so
# `harness_scaffold.<name>` stays a valid attribute path.
try:
    from _md_anchors import (
        _HEADING_RE,  # noqa: F401
        _SETEXT_RE,  # noqa: F401
        _has_anchor,
        _slugify,  # noqa: F401
        _strip_code,
        _strip_frontmatter,
    ...
    from scripts._md_anchors import (
        _HEADING_RE,  # noqa: F401
        _SETEXT_RE,  # noqa: F401
        _has_anchor,
        _slugify,  # noqa: F401
